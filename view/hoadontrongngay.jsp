...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small> Hóa đơn trong ngày </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Hóa đơn trong ngày</a></li>
            <li class="active"><a href="${pageContext.request.contextPath}/hoadontrongngay.jsp">Danh sách</a></li>  
        </ol>
    </section>
