...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/danhsachnhacungcap">Danh sách</a></li>
            ...
            <div class="box box-default collapsed-box" >
                ...
                <div class="box-footer" style="display: none;">
                    <div class="input-group-btn">
                        <button id="add-new-event" type="button" style="float: right; margin-right: 20px; " class="btn btn-primary btn-flat" onclick="addNewNhaCungCap();">Thêm</button>
                    </div>
                </div>
            </div>
        </form>
