...
<div class="content-wrapper">
    <div class="content-header">
        <h1>
            ...
            <small>Quản lí Khách hàng</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Quản lí Khách hàng</a></li>
            <li class="active"><a href="${pageContext.request.contextPath}/danhsachkhachhang">Danh sách</a></li>
             <li class="active"><a href="#">Sửa thông tin</a></li>
        </ol>
    </div>
    <div class="content">
        <div class="box">
