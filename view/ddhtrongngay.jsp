...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small> Đặt hàng trong ngày </small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Đặt hàng trong ngày</a></li>
            <li class="active"><a href="${pageContext.request.contextPath}/ddhtrongngay.jsp">Danh sách</a></li>  
        </ol>
    </section>
