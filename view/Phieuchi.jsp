...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            ...
            <small>Danh sách phiếu chi</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Danh sách phiếu chi</a></li>
            <li class="active"><a href="${pageContext.request.contextPath}/loaddsphieuchi">Danh sách</a></li>
        </ol>
    </section>
