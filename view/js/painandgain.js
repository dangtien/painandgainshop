...
function addEmployee() {
    ...
    $.get("/addemployee",
            {Tennv: tennv, Luong: luong, Username: username, Password: pass, Email: email, Diachi: diachi, Sodt: sodt, Ghichu: ghichu},
            function (data) {
...
function addNewNhaCungCap(){
    var ten = $("#inputText1").val();
    var diachi = $("#inputText2").val();
    var sodt = $("#inputText3").val();
    var email = $("#inputText4").val();
    var masothue = $("#inputText5").val();
    var ghichu = $("#inputText6").val();
    $.get("/addnewncc",
    {
        TenNcc:ten,
        Mst:masothue,
